...
@Component({
  selector: 'app-distortion-landing-page',
  templateUrl: './distortion-landing-page.component.html',
  styleUrls: ['./distortion-landing-page.component.sass'],
})
export class DistortionLandingPageComponent implements OnInit {
  constructor() {}
  ...
  ngOnInit(): void {
    ...
    var myAnimation = new hoverEffect({
      ...
      image1: `../../../assets/Distortion_landing_page/${bgImgs[0]}`,
      image2: `../../../assets/Distortion_landing_page/${bgImgs[1]}`,
      displacementImage: '../../../assets/Distortion_landing_page/14.jpg',
      hover: false,
    });
    ...
    var myAnimation2 = new hoverEffect({
      ...
      intensity: 0.3,
      imagesRatio: 1080 / 1920,
      image1: `../../../assets/Distortion_landing_page/${bgImgs[1]}`,
      image2: `../../../assets/Distortion_landing_page/${bgImgs[2]}`,
      displacementImage: '../../../assets/Distortion_landing_page/14.jpg',
      hover: false,
    });
    ...
    var myAnimation3 = new hoverEffect({
      ...
      intensity: 0.3,
      imagesRatio: 1080 / 1920,
      image1: `../../../assets/Distortion_landing_page/${bgImgs[2]}`,
      image2: `../../../assets/Distortion_landing_page/${bgImgs[3]}`,
      displacementImage: '../../../assets/Distortion_landing_page/14.jpg',
      hover: false,
    });
    ...
    var myAnimation4 = new hoverEffect({
      ...
      intensity: 0.3,
      imagesRatio: 1080 / 1920,
      image1: `../../../assets/Distortion_landing_page/${bgImgs[3]}`,
      image2: `../../../assets/Distortion_landing_page/${bgImgs[0]}`,
      displacementImage: '../../../assets/Distortion_landing_page/14.jpg',
      hover: false,
    });
    ...
    function showTextAnimation(direction) {
      if (titleDisplacement === 0 && direction === 'prev') {
        titleDisplacement = -252;
      } else if (titleDisplacement === -252 && direction === 'next') {
        titleDisplacement = 0;
      } else {
        titleDisplacement =
          direction === 'next'
            ? titleDisplacement - 84
            : titleDisplacement + 84;
      }
